...
function loadCharas(){
	...
	var TLAvatar = document.getElementById("TLAvatarImage");
	var TRAvatar = document.getElementById("TRAvatarImage");
	var BLAvatar = document.getElementById("BLAvatarImage");
	var BRAvatar = document.getElementById("BRAvatarImage");
